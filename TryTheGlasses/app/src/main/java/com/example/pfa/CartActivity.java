    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                totalAmount.setText("Total Price :"+String.valueOf(totalprice)+"DH");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                int pricetotalproduct=(Integer.valueOf(model.getPrice()))*(Integer.valueOf(model.getQuantity()));
                totalprice=pricetotalproduct+pricetotalproduct;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Conguralations , your final order has been shipped successfully. Soon will received your order at your door step.");
