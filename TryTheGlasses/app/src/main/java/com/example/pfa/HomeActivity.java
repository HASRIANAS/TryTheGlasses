...
import com.example.pfa.Admin.AdminMaintainProductsActivity;
import com.example.pfa.Model.Products;
import com.example.pfa.Prevalent.Prevalent;
import com.example.pfa.ViewHolder.ProductViewHolder;
                ...
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final ProductViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.tester.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(HomeActivity.this,"Tester",Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(HomeActivity.this,ProductTryOnActivity.class);
